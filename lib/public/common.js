(function(scope){
	...
	scope.nowpadCommon = {
		...
		applyPatch: function(_patchesStr,_value,selectionRange) {
			// Prepare
			var
			...
			selectionRange.selectionStart = selectionRange.selectionStart || 0;
			selectionRange.selectionEnd = selectionRange.selectionEnd || selectionRange.selectionStart || 0;
