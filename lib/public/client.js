(function(window,undefined){
	...
	nowpadClient.prototype = {
		...
		sync: function(){
			...
			oldSelectionRange = this.selectionRange = this.getSelectionRange();
			...
			if ( this.getValue() !== newCurrentValue ) {
				...
				this.selectionRange.selectionStart += (newSelectionRange.selectionStart-newSelectionRange.selectionStart);
				this.selectionRange.selectionEnd += (newSelectionRange.selectionEnd-newSelectionRange.selectionEnd);
