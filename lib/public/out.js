    ...
    Element = (function() {
      ...
      Element.prototype.active = function(value) {
        ...
        if ((value != null) && value === true) {
          ...
          switch (this.elementType) {
            case 'ace':
              this.element.textInput.getElement().focus() === document.activeElement;
              break;
            case 'jquery':
              result = this.element.find(document.activeElement).add(this.element.filter(document.activeElement));
              break;
            case 'native':
